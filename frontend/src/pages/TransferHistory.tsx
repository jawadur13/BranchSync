        ...
        printWindow.document.write(`
            <html>
                ...
                <body>
                    ...
                    <h3 style="color: #0f172a; margin-bottom: 10px;">${user?.role === 'SYSTEM_ADMIN' ? '📜 All Transfer Request History' : '📜 Transfer Request History'}</h3>
                    <table>
                        <thead>
                            <tr>
                ...
                <div>
                    ...
                    <p className="hist-subtitle">
                        {user?.role === 'SYSTEM_ADMIN'
                            ...
                            : user?.role === 'HQ_LOGISTICS_OFFICER'
                            ? 'All transfer requests (active, in-transit, and closed)'
                            : 'All transfer requests from your branch (active, in-transit, and closed)'}
                    </p>
                </div>
