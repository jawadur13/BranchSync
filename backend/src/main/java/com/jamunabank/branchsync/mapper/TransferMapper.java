...
public class TransferMapper {
    ...
    public TransferResponseDto toResponseDto(TransferRequest e) {
        ...
        return TransferResponseDto.builder()
                ...
                .initiatedById(e.getInitiatedBy() != null ? e.getInitiatedBy().getUserId() : null)
                .internalApproverId(e.getInternalApprover() != null ? e.getInternalApprover().getUserId() : null)
                .hqApproverId(e.getHqApprover() != null ? e.getHqApprover().getUserId() : null)
                .deptAcceptorId(e.getDeptAcceptor() != null ? e.getDeptAcceptor().getUserId() : null)
                .finalReleaserId(e.getFinalReleaser() != null ? e.getFinalReleaser().getUserId() : null)
